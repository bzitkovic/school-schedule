...
-- Started on 2021-01-11 22:38:11
...
CREATE VIEW public.izlistaj_dvorane AS
 SELECT d.id_zgrade AS id_zgrade_dvorana,
...
--
-- TOC entry 219 (class 1259 OID 33162)
...
10	Srijeda	08:00:00	22:00:00
1	Utorak	10:00:00	00:00:00
\.
...
SELECT pg_catalog.setval('public.dvorana_id_dvorane_seq', 7, true);
...
SELECT pg_catalog.setval('public.korisnik_id_korisnika_seq', 69, true);
...
SELECT pg_catalog.setval('public.nastavnik_id_nastavnika_seq', 7, true);
...
SELECT pg_catalog.setval('public.predmet_id_predmeta_seq', 14, true);
...
SELECT pg_catalog.setval('public.raspored_id_rasporeda_seq', 5, true);
...
SELECT pg_catalog.setval('public.vrijeme_id_vremena_seq', 14, true);
...
SELECT pg_catalog.setval('public."zgrada_ID_zgrade_seq"', 3, true);
...
-- Completed on 2021-01-11 22:38:12
